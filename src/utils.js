...
function getQuestions(subCommand) {
    if (subCommand === 'fielder') {
        return [
            { label: "打席数", q: "打席数を入力してください", key: 'plateAppearance' },
            { label: "打数", q: "打数を入力してください", key: 'atBat' },
            { label: "安打数", q: "安打数を入力してください", key: 'hit' },
            { label: "二塁打", q: "二塁打数を入力してください", key: 'doubleHit' },
            { label: "三塁打", q: "三塁打数を入力してください", key: 'triple' },
            { label: "本塁打", q: "本塁打数を入力してください", key: 'homeRun' },
            { label: "四球", q: "四球を入力してください", key: 'walk' },
            { label: "死球", q: "死球を入力してください", key: 'hbp' },
            { label: "盗塁", q: "盗塁数を入力してください", key: 'steal' },
            { label: "盗塁死", q: "盗塁死数を入力してください", key: 'caughtStealing' },
            { label: "好走塁", q: "好走塁を入力してください", key: 'goodBaseRunning' },
            { label: "併殺打", q: "併殺打数を入力してください", key: 'doublePlay' },
            { label: "失策", q: "失策数を入力してください", key: 'error' },
            { label: "好守備", q: "好守備を入力してください", key: 'finePlay' },
            { label: "盗塁刺 (捕手)", q: "捕手: 盗塁刺数を入力してください (捕手以外は0)", key: 'catchStealing' },
            { label: "許盗塁 (捕手)", q: "捕手: 許盗塁数を入力してください (捕手以外は0)", key: 'stolenBasesAllowed' },
            { label: "守備試合: 捕手", q: "捕手としての出場試合数", key: 'cGame' },
            { label: "守備試合: 一塁", q: "一塁手としての出場試合数", key: 'fbGame' },
            { label: "守備試合: 二塁", q: "二塁手としての出場試合数", key: 'sbGame' },
            { label: "守備試合: 三塁", q: "三塁手としての出場試合数", key: 'tbGame' },
            { label: "守備試合: 遊撃", q: "遊撃手としての出場試合数", key: 'ssGame' },
            { label: "守備試合: 左翼", q: "左翼手としての出場試合数", key: 'lfGame' },
            { label: "守備試合: 中堅", q: "中堅手としての出場試合数", key: 'cfGame' },
            { label: "守備試合: 右翼", q: "右翼手としての出場試合数", key: 'rfGame' },
            { label: "守備試合: 指名", q: "指名打者としての出場試合数", key: 'dhGame' },
        ];
    } else if (subCommand === 'pitcher') {
        return [
            { label: "投球回", q: "投球回を入力してください (例: 143回1/3 -> 143.333)", key: 'innings' },
            { label: "自責点", q: "自責点を入力してください", key: 'earnedRuns' },
            { label: "被安打", q: "被安打数を入力してください", key: 'hitsAllowed' },
            { label: "被本塁打", q: "被本塁打数を入力してください", key: 'homeRunsAllowed' },
            { label: "与四球", q: "与四球数を入力してください", key: 'walksAllowed' },
            { label: "与死球", q: "与死球数を入力してください", key: 'hitBatsmen' },
            { label: "奪三振", q: "奪三振数を入力してください", key: 'strikeouts' },
            { label: "登板数", q: "登板数を入力してください", key: 'appearances' },
            { label: "先発数", q: "先発数を入力してください", key: 'starts' },
        ];
    }
    return [];
}
